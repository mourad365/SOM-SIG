...
This project is indexed by GitNexus as **SOM-SIG** (1331 symbols, 1835 relationships, 26 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
